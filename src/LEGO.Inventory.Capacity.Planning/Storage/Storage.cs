...
namespace LEGO.Inventory.Capacity.Planning.Storage
{
    public class Storage : IStorage
    {
        ...
        // public Task<IEnumerable<StockTransportOrder>> StockTransportOrders { get; set; }
        //    public async Task<IEnumerable<StockTransportOrder>> StockTransportOrders { get; set; } = new List<StockTransportOrder>();
        // Task<IEnumerable<StockTransportOrder>> IStorage.StockTransportOrders { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
    }
}
